...
function parseSqlArguments(model, typeName, gqlArgs) {
    ...
    if (gqlArgs.orderBy) {
        args.orderBy = (0, orderBy_1.parseOrderBy)(model, typeName, { orderBy: gqlArgs.orderBy, direction: gqlArgs.orderDirection });
    }
    if (gqlArgs.skip) {
        (0, assert_1.default)(typeof gqlArgs.skip == 'number');
        args.offset = gqlArgs.skip;
    }
    if (gqlArgs.first != null) {
        (0, assert_1.default)(typeof gqlArgs.first == 'number');
