...
(0, inflected_1.inflections)(THEGRAPH_LOCALE, (inflector) => {
    ...
    inflector.plural(/(\w*(alumn|syllab|octop|vir|radi|nucle|fung|cact|stimul|termin|bacill|foc|uter|loc|strat))(?:us|i)$/, '$1i');
    inflector.plural(/(\w*(alumn|alg|vertebr))(?:a|ae)$/, '$1ae');
    inflector.plural(/(\w*(seraph|cherub))(?:im)?$/, '$1im');
    inflector.plural(/(\w*(her|at|gr))o$/, '$1oes');
    inflector.plural(/(\w*(agend|addend|millenni|dat|extrem|bacteri|desiderat|strat|candelabr|errat|ov|symposi|curricul|automat|quor))(?:a|um)$/, '$1a');
    inflector.plural(/(\w*(apheli|hyperbat|periheli|asyndet|noumen|phenomen|criteri|organ|prolegomen|hedr|automat))(?:a|on)$/, '$1a');
