...
const apollo_server_express_1 = require("@subsquid/apollo-server-express");
...
async function serve(options) {
    let { connection, subscriptionConnection, subscriptionPollInterval, maxResponseNodes, subscriptionMaxResponseNodes, validationMaxErrors, log, } = options;
    ...
    let context = () => {
        let openreader = new db_1.PoolOpenreaderContext(dbType, connection, subscriptionConnection, subscriptionPollInterval, isolationLevel, log);
        if (maxResponseNodes) {
