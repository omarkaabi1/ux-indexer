...
describe('response size limits', function () {
    ...
    describe(dialect_1.Dialect.OpenCrud, function () {
        const client = (0, setup_1.useServer)(schema, opts);
    ...
    describe(dialect_1.Dialect.TheGraph, function () {
        const client = (0, setup_1.useServer)(schema, { ...opts, dialect: dialect_1.Dialect.TheGraph });
        it('unlimited requests fail', async function () {
            let result = await client.query(`
                query {
                    order1s {
