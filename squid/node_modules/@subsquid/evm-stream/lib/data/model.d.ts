import type { BlockRequiredFields, LogRequiredFields, StateDiffRequiredFields, TraceRequiredFields, TransactionRequiredFields } from './partial';
import type { EvmBlockHeader, EvmLog, EvmStateDiff, EvmStateDiffBase, EvmTraceBase, EvmTraceCallAction, EvmTraceCallResult, EvmTraceCreateAction, EvmTraceCreateResult, EvmTraceRewardAction, EvmTraceSuicideAction, EvmTransaction } from './evm';
...
export interface FieldSelection {
    ...
    trace?: Selector<Exclude<keyof EvmTraceBase, TraceRequiredFields> | Prefixed<'create', keyof EvmTraceCreateAction> | Prefixed<'createResult', keyof EvmTraceCreateResult> | Prefixed<'call', keyof EvmTraceCallAction> | Prefixed<'callResult', keyof EvmTraceCallResult> | Prefixed<'suicide', keyof EvmTraceSuicideAction> | Prefixed<'reward', keyof EvmTraceRewardAction>>;
 ...
 */
type Item<Data, Required extends keyof Data, F extends FieldSelection, K extends FieldKey> = Simplify<Pick<Data, Required> & Select<Data, GetFields<F, K>>>;
...
export type TraceCreateAction<F extends FieldSelection = {}> = Select<EvmTraceCreateAction, TraceActionFields<'create', F>>;
export type TraceCreateResult<F extends FieldSelection = {}> = Select<EvmTraceCreateResult, TraceActionFields<'createResult', F>>;
export type TraceCallAction<F extends FieldSelection = {}> = Select<EvmTraceCallAction, TraceActionFields<'call', F>>;
export type TraceCallResult<F extends FieldSelection = {}> = Select<EvmTraceCallResult, TraceActionFields<'callResult', F>>;
export type TraceSuicideAction<F extends FieldSelection = {}> = Select<EvmTraceSuicideAction, TraceActionFields<'suicide', F>>;
export type TraceRewardAction<F extends FieldSelection = {}> = Select<EvmTraceRewardAction, TraceActionFields<'reward', F>>;
type TraceBase<F extends FieldSelection = {}> = Simplify<Pick<EvmTraceBase, Exclude<TraceRequiredFields, 'type'>> & Select<EvmTraceBase, GetFields<F, 'trace'>>>;
