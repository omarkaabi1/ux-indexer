...
export declare function partitionBy<T, V>(items: T[], value: (a: T) => V): Iterable<{
    items: T[];
    value: V;
}>;
export declare function bisect<I, K>(items: I[], key: K, compare: (item: I, key: K) => number): number;
