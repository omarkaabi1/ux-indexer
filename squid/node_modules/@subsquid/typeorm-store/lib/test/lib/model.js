...
exports.Data = exports.Order = exports.Item = exports.IdOnly = void 0;
const typeorm_1 = require("typeorm");
let IdOnly = class IdOnly {
    constructor(id) {
        if (id != null) {
            this.id = id;
        }
...
], IdOnly.prototype, "id", void 0);
exports.IdOnly = IdOnly = __decorate([
    (0, typeorm_1.Entity)(),
...
__decorate([
    (0, typeorm_1.Column)('numeric', {
        transformer: { from: (s) => (s == null ? null : BigInt(s)), to: (val) => val?.toString() },
    }),
    __metadata("design:type", Object)
